...
- $\hat{\theta}_2 = \frac{X + \sqrt{n}/2}{n+\sqrt{n}}$ (estimateur de Bayes minimax)
- $\hat{\theta}_3 = \frac{1}{2}$ (estimateur constant)
- $\hat{\theta}_4 = \frac{X+1}{n+2}$ (MAP avec loi a priori uniforme sur $[0,1]$)
...
```{r, echo=FALSE, fig.width=10, fig.height=5, fig.align='center', fig.retina=2, warning=FALSE, message=FALSE}
n <- seq(10,100)
r1 <- 1/6/n
r2 <- 1/4/(1+sqrt(n))^2
r3 <- rep(1/12,length(n))
r4 <- 1/6/(n+2)
par(mar=c(7, 2, 1, 2), xpd=TRUE,mfrow=c(1,2))
plot(n,log(r1),type="l",col="#0000CC",lwd=2,xlab="n",ylab="risque de Bayes (log)",ylim=c(-6.3,-2.4))
lines(n,log(r2),col="#CC0000",lwd=2)
lines(n,log(r3),col="#CC7700",lwd=2)
lines(n,log(r4),col="#007700",lwd=2)
legend("bottom",legend=c("R1","R2","R3","R4"),lty=1,col=c("#0000CC","#CC0000","#CC7700","#007700"),bty="n",lwd=2,inset=c(0,-0.3),horiz=TRUE)
plot(n,log(r1),type="l",col="#0000CC",lwd=2,xlab="n",ylab="risque de Bayes (log)")
lines(n,log(r2),col="#CC0000",lwd=2)
lines(n,log(r4),col="#007700",lwd=2)
```
...
<span style="color:#16A085">**fin du cours 17 (18/03/2025)**</span>
...
<span style="color:#16A085">**fin du cours 18 (24/03/2025)**</span>
